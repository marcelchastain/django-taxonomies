...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TaxonomyGroup.display_name'
        db.add_column(u'taxonomy_taxonomygroup', 'display_name',
                      self.gf('django.db.models.fields.CharField')(max_length=150, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TaxonomyGroup.display_name'
        db.delete_column(u'taxonomy_taxonomygroup', 'display_name')
